...
package net.mcreator.thescorchedwastelands.entity;
...
import net.mcreator.thescorchedwastelands.item.RustyBladeItem;
import net.mcreator.thescorchedwastelands.entity.renderer.MeleeDeadbeatRenderer;
...
public class MeleeDeadbeatEntity extends TheScorchedWastelandsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("melee_deadbeat").setRegistryName("melee_deadbeat");

	public MeleeDeadbeatEntity(TheScorchedWastelandsModElements instance) {
		super(instance, 9);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MeleeDeadbeatRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -11892103, -5528967, new Item.Properties().group(ScorchedWastelandsItemGroup.tab))
				.setRegistryName("melee_deadbeat_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(RustyBladeItem.block));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(ScorchedDebrisBlock.block));
		}

		@Override
		public void playStepSound(BlockPos pos, BlockState blockIn) {
			this.playSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
					.getValue(new ResourceLocation("the_scorched_wastelands:junkfootstep")), 0.15f, 1);
		}
