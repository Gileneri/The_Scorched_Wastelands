...
public class BrokensmalldrawerBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:brokensmalldrawer")
	public static final Block block = null;

	public BrokensmalldrawerBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.SCAFFOLDING).hardnessAndResistance(1f, 3f).setLightLevel(s -> 1)
					.harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, false));
			setRegistryName("brokensmalldrawer");
		}
