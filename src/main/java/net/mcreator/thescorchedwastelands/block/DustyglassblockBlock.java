...
public class DustyglassblockBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:dustyglassblock")
	public static final Block block = null;

	public DustyglassblockBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 96);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dustyglassblock");
		}
