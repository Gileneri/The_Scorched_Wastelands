...
public class MetalplaquestairsBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:metalplaquestairs")
	public static final Block block = null;

	public MetalplaquestairsBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 118);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("metalplaquestairs");
		}
