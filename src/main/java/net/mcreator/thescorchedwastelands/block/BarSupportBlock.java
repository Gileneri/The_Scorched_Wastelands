...
public class BarSupportBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:bar_support")
	public static final Block block = null;

	public BarSupportBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 52);
	}
