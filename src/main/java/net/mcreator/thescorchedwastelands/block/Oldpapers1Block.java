...
public class Oldpapers1Block extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:oldpapers_1")
	public static final Block block = null;

	public Oldpapers1Block(TheScorchedWastelandsModElements instance) {
		super(instance, 164);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("oldpapers_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_scorched_wastelands:oldpapers_1"), configuredFeature);
		}
	}
