...
public class DarkglasspaneBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:darkglasspane")
	public static final Block block = null;

	public DarkglasspaneBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 124);
	}
