...
public class RusteddrainBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:rusteddrain")
	public static final Block block = null;

	public RusteddrainBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 128);
	}
