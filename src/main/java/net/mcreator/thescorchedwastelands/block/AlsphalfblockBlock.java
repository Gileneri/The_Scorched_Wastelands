...
public class AlsphalfblockBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:alsphalfblock")
	public static final Block block = null;

	public AlsphalfblockBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 155);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.BASALT).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).harvestLevel(2)
					.harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("alsphalfblock");
		}
