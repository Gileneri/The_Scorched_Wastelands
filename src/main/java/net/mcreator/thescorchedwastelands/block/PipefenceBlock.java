...
public class PipefenceBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:pipefence")
	public static final Block block = null;

	public PipefenceBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 170);
	}
