...
public class RoughstoneBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:roughstone")
	public static final Block block = null;

	public RoughstoneBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 168);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("the_scorched_wastelands:roughstone_match"),
			...
			event.getRegistry().register(feature.setRegistryName("roughstone"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_scorched_wastelands:roughstone"), configuredFeature);
		}
	}
