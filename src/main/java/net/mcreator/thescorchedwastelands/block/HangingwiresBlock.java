...
public class HangingwiresBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:hangingwires")
	public static final Block block = null;

	public HangingwiresBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 68);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.LANTERN).hardnessAndResistance(1f, 1.2f).setLightLevel(s -> 1)
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ScorchedgrassBlock.block));
		}
	}
}
