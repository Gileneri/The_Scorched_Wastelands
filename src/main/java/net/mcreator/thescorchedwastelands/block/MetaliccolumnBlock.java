...
public class MetaliccolumnBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:metaliccolumn")
	public static final Block block = null;

	public MetaliccolumnBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 109);
	}
