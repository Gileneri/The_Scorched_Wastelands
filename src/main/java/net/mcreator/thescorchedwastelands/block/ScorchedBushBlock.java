...
public class ScorchedBushBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:scorched_bush")
	public static final Block block = null;

	public ScorchedBushBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 7);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("scorched_bush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_scorched_wastelands:scorched_bush"),
					configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.HUNGER, 100, Block.Properties.create(Material.PLANTS, MaterialColor.BROWN).doesNotBlockMovement().sound(SoundType.CORAL)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 0));
			setRegistryName("scorched_bush");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.STICK, (int) (3)));
		}

		@Override
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			Block ground = state.getBlock();
			return (ground == Blocks.RED_SAND || ground == Blocks.SAND || ground == JunkpileBlock.block || ground == DrySandBlock.block
					|| ground == RedDrySandBlock.block || ground == DrydirtBlock.block
