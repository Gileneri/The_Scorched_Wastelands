...
public class ScorchedmetalBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:scorchedmetal")
	public static final Block block = null;

	public ScorchedmetalBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 89);
	}
