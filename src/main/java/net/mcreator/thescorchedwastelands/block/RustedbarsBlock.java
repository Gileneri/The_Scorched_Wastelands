...
public class RustedbarsBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:rustedbars")
	public static final Block block = null;

	public RustedbarsBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 102);
	}
