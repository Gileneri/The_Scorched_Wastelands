...
public class MetalsheetsBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:metalsheets")
	public static final Block block = null;

	public MetalsheetsBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 104);
	}
