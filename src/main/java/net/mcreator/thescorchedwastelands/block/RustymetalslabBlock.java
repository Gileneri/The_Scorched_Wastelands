...
public class RustymetalslabBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:rustymetalslab")
	public static final Block block = null;

	public RustymetalslabBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("rustymetalslab");
		}
