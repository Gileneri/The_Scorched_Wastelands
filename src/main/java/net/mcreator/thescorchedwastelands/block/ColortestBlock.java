...
public class ColortestBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:colortest")
	public static final Block block = null;

	public ColortestBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 166);
	}
