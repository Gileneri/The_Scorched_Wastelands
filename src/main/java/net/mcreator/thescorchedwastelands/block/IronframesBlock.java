...
public class IronframesBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:ironframes")
	public static final Block block = null;

	public IronframesBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 48);
	}
