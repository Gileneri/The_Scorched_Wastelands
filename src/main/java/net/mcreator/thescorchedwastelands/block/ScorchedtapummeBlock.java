...
public class ScorchedtapummeBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:scorchedtapumme")
	public static final Block block = null;

	public ScorchedtapummeBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 106);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("scorchedtapumme");
		}
