...
public class RustymetalplaqueslabBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:rustymetalplaqueslab")
	public static final Block block = null;

	public RustymetalplaqueslabBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 117);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("rustymetalplaqueslab");
		}
