...
public class DarkglassBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:darkglass")
	public static final Block block = null;

	public DarkglassBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 123);
	}
