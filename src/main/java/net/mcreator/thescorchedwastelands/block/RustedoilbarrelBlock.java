...
public class RustedoilbarrelBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:rustedoilbarrel")
	public static final Block block = null;

	public RustedoilbarrelBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 147);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.ANVIL).hardnessAndResistance(1f, 6f).setLightLevel(s -> 1).harvestLevel(2)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y).with(WATERLOGGED, false));
			setRegistryName("rustedoilbarrel");
		}
