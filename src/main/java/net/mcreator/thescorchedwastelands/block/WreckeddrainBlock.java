...
public class WreckeddrainBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:wreckeddrain")
	public static final Block block = null;

	public WreckeddrainBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 111);
	}
