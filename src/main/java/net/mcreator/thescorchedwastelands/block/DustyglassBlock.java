...
public class DustyglassBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:dustyglass")
	public static final Block block = null;

	public DustyglassBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 95);
	}
