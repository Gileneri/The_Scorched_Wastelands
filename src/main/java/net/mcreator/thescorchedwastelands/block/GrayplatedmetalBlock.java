...
public class GrayplatedmetalBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:grayplatedmetal")
	public static final Block block = null;

	public GrayplatedmetalBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 90);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("grayplatedmetal");
		}
