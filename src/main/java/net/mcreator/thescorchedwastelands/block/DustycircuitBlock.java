...
public class DustycircuitBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:dustycircuit")
	public static final Block block = null;

	public DustycircuitBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1f, 2.5f).setLightLevel(s -> 0).harvestLevel(2)
					.harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("dustycircuit");
		}
