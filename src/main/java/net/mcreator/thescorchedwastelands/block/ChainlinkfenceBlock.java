...
public class ChainlinkfenceBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:chainlinkfence")
	public static final Block block = null;

	public ChainlinkfenceBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.CHAIN).hardnessAndResistance(1f, 5f).setLightLevel(s -> 0).harvestLevel(2)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("chainlinkfence");
		}
