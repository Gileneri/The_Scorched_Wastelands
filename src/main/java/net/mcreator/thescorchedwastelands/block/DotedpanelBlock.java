...
public class DotedpanelBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:dotedpanel")
	public static final Block block = null;

	public DotedpanelBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 92);
	}
