...
public class MetalplaquesBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:metalplaques")
	public static final Block block = null;

	public MetalplaquesBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 114);
	}
