...
public class RustymetalBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:rustymetal")
	public static final Block block = null;

	public RustymetalBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 35);
	}
