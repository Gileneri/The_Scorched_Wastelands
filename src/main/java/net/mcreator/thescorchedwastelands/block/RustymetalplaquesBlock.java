...
public class RustymetalplaquesBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:rustymetalplaques")
	public static final Block block = null;

	public RustymetalplaquesBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 115);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rustymetalplaques");
		}
