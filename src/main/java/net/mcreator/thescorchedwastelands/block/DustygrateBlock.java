...
public class DustygrateBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:dustygrate")
	public static final Block block = null;

	public DustygrateBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 97);
	}
