...
public class GrateBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:grate")
	public static final Block block = null;

	public GrateBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 94);
	}
