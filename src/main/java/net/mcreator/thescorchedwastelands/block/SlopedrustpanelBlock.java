...
public class SlopedrustpanelBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:slopedrustpanel")
	public static final Block block = null;

	public SlopedrustpanelBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 112);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slopedrustpanel");
		}
