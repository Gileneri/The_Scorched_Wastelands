...
public class SleekdarkpanelBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:sleekdarkpanel")
	public static final Block block = null;

	public SleekdarkpanelBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 169);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sleekdarkpanel");
		}
