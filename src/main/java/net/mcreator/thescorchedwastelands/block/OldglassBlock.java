...
public class OldglassBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:oldglass")
	public static final Block block = null;

	public OldglassBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 122);
	}
