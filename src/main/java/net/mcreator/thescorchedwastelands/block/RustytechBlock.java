...
public class RustytechBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:rustytech")
	public static final Block block = null;

	public RustytechBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 113);
	}
