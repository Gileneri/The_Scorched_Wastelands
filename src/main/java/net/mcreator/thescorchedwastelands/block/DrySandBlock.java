...
public class DrySandBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:dry_sand")
	public static final Block block = null;

	public DrySandBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 12);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH, MaterialColor.SAND).sound(SoundType.SOUL_SAND).hardnessAndResistance(1f, 10f)
					.setLightLevel(s -> 0).harvestLevel(1).harvestTool(ToolType.SHOVEL));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("dry_sand");
		}
	...
	private static class CustomRuleTest extends RuleTest {
		...
		public boolean test(BlockState blockAt, Random random) {
			...
			if (blockAt.getBlock() == Blocks.STONE)
				blockCriteria = true;
			if (blockAt.getBlock() == Blocks.ORANGE_TERRACOTTA)
				blockCriteria = true;
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("the_scorched_wastelands:dry_sand_match"),
			...
			event.getRegistry().register(feature.setRegistryName("dry_sand"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_scorched_wastelands:dry_sand"), configuredFeature);
		}
	}
