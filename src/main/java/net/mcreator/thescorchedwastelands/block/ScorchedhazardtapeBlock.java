...
public class ScorchedhazardtapeBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:scorchedhazardtape")
	public static final Block block = null;

	public ScorchedhazardtapeBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 105);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.SCAFFOLDING).hardnessAndResistance(1f, 1.5f).setLightLevel(s -> 0)
					.harvestLevel(2).harvestTool(ToolType.AXE).setRequiresTool());
			setRegistryName("scorchedhazardtape");
		}
