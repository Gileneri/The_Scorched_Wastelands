...
public class RedDrySandBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:red_dry_sand")
	public static final Block block = null;

	public RedDrySandBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 15);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("the_scorched_wastelands:red_dry_sand_match"),
			...
			event.getRegistry().register(feature.setRegistryName("red_dry_sand"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_scorched_wastelands:red_dry_sand"), configuredFeature);
		}
	}
