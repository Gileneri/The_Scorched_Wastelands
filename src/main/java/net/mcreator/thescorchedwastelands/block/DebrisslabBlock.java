...
public class DebrisslabBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:debrisslab")
	public static final Block block = null;

	public DebrisslabBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.NETHER_BRICK).hardnessAndResistance(1f, 1.5f).setLightLevel(s -> 0)
					.notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("debrisslab");
		}
