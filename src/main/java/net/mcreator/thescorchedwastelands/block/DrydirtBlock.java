...
public class DrydirtBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:drydirt")
	public static final Block block = null;

	public DrydirtBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 23);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("the_scorched_wastelands:drydirt_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 30)).range(128)
					.square().func_242731_b(15);
			event.getRegistry().register(feature.setRegistryName("drydirt"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_scorched_wastelands:drydirt"), configuredFeature);
		}
	}
