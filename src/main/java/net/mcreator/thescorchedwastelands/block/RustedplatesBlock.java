...
public class RustedplatesBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:rustedplates")
	public static final Block block = null;

	public RustedplatesBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 103);
	}
