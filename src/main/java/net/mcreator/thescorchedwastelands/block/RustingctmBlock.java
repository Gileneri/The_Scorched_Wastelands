...
public class RustingctmBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:rustingctm")
	public static final Block block = null;

	public RustingctmBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 88);
	}
