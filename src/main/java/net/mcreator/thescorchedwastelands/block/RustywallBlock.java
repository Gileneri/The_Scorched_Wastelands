...
public class RustywallBlock extends TheScorchedWastelandsModElements.ModElement {
	@ObjectHolder("the_scorched_wastelands:rustywall")
	public static final Block block = null;

	public RustywallBlock(TheScorchedWastelandsModElements instance) {
		super(instance, 120);
	}
