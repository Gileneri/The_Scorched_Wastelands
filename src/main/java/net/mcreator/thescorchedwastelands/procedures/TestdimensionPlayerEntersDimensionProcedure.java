	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				TheScorchedWastelandsMod.LOGGER.warn("Failed to load dependency entity for procedure TestdimensionPlayerEntersDimension!");
			return;
		}
		...
		}.check(entity)) && (entity.world.getDimensionKey()) == (RegistryKey.getOrCreateKey(Registry.WORLD_KEY,
				new ResourceLocation("the_scorched_wastelands:testdimension")))) {
			if (entity instanceof LivingEntity)
				((LivingEntity) entity).addPotionEffect(new EffectInstance(WaitpotionPotionEffect.potion, (int) 5250, (int) 1, (false), (false)));
		...
		}.getItemStack((int) (0))).getItem() == FemboymilkbucketItem.block) {
			{
				Entity _ent = entity;
				if (_ent instanceof ServerPlayerEntity) {
					Container _current = ((ServerPlayerEntity) _ent).openContainer;
		...
		}.getItemStack((int) (1))).getItem() == FemboymilkbucketItem.block) {
			{
				Entity _ent = entity;
				if (_ent instanceof ServerPlayerEntity) {
					Container _current = ((ServerPlayerEntity) _ent).openContainer;
		...
		}.getItemStack((int) (2))).getItem() == FemboymilkbucketItem.block) {
			{
				Entity _ent = entity;
				if (_ent instanceof ServerPlayerEntity) {
					Container _current = ((ServerPlayerEntity) _ent).openContainer;
		...
		}.getItemStack((int) (3))).getItem() == FemboymilkbucketItem.block) {
			{
				Entity _ent = entity;
				if (_ent instanceof ServerPlayerEntity) {
					Container _current = ((ServerPlayerEntity) _ent).openContainer;
		...
		}.getItemStack((int) (4))).getItem() == FemboymilkbucketItem.block) {
			{
				Entity _ent = entity;
				if (_ent instanceof ServerPlayerEntity) {
					Container _current = ((ServerPlayerEntity) _ent).openContainer;
		...
		}.getItemStack((int) (5))).getItem() == FemboymilkbucketItem.block) {
			{
				Entity _ent = entity;
				if (_ent instanceof ServerPlayerEntity) {
					Container _current = ((ServerPlayerEntity) _ent).openContainer;
		...
		}.getItemStack((int) (6))).getItem() == FemboymilkbucketItem.block) {
			{
				Entity _ent = entity;
				if (_ent instanceof ServerPlayerEntity) {
					Container _current = ((ServerPlayerEntity) _ent).openContainer;
		...
		}.getItemStack((int) (7))).getItem() == FemboymilkbucketItem.block) {
			{
				Entity _ent = entity;
				if (_ent instanceof ServerPlayerEntity) {
					Container _current = ((ServerPlayerEntity) _ent).openContainer;
		...
		}.getItemStack((int) (8))).getItem() == FemboymilkbucketItem.block) {
			{
				Entity _ent = entity;
				if (_ent instanceof ServerPlayerEntity) {
					Container _current = ((ServerPlayerEntity) _ent).openContainer;
