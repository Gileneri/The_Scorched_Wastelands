...
public class TestplainsBiome extends TheScorchedWastelandsModElements.ModElement {
	public static Biome biome;

	public TestplainsBiome(TheScorchedWastelandsModElements instance) {
		super(instance, 42);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-3591664).setWaterColor(-13820928).setWaterFogColor(-13818862)
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(RedDrySandBlock.block.getDefaultState(),
								RedDrySandBlock.block.getDefaultState(), JunkpileBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("the_scorched_wastelands:testplains"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("testplains_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("testplains_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("testplains_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
